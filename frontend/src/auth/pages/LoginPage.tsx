    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 text-2xl font-bold mb-3 cursor-pointer" onClick={() => navigate("/")}>
          ...
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Track, analyze, and improve your problem-solving skills
              </p>
            </div>
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full gap-3 h-12 text-base font-medium cursor-pointer"
              onClick={handleLogin}
            >
